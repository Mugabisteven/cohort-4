...
// Defining a method with an object electronics with five properties,five instances and printing them out
function 
electronics(name,make,color,price,origin)
{
    this.name=name
    this.make=make
    this.color=color
...
var fridge= new electronics("fridge","LG","black",3000000,"uk")

var TV= new electronics("TV","samsung","black",400000,"uk")

var Cooker=new electonics("cooker","IQRA","white","400000","chaina")
